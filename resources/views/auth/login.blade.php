<x-guest-layout>
    ...
    <h1 class="text-center text-xl text-white"><b>Login Form</b></h1>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 p-2 w-full  bg-white outline-black" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block p-2 mt-1 w-full bg-white text-dark"
                            type="password"
                            name="password"
